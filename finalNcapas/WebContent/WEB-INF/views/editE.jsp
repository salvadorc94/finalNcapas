...
<form:form  action="${pageContext.request.contextPath}/editar?cbr=${sucursal.codigo}" method="POST" modelAttribute="empleado">
		<form:input type="hidden" name="codigoo" path="codigo"/>
		<label>Name: </label>
		...
		<form:errors path="edad" cssStyle="color: #ff0000;"/><br>
		
		<label>Gender: </label>
		<form:input type="text" name="genero" path="genero"/><br>
		<form:errors path="genero" cssStyle="color: #ff0000;"/><br>
